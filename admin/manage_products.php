    ...
    <header>
        ...
        <nav>
            ...
            <div id="line"></div>
					...
					<tr>
					<td>
					<form action="updateProducts_action.php?col=product_brand" method="post">
							<b><?php echo $row['product_brand']; ?></b><br>
							<input type="text" size="10" name="username">
							<input type="hidden" name="productsToUpdate" value="<?php echo $row['product_id'] ?>">
							<button type="submit" class="updateButton">Update</button>
						 </form>
						</td>
						<td>
						<form action="updateProducts_action.php?col=product_name" method="post">
							<b><?php echo $row['product_name']; ?></b><br>
							<input type="text" size="10" name="product_name">
							<input type="hidden" name="productsToUpdate" value="<?php echo $row['product_id'] ?>">
							<button type="submit" class="updateButton">Update</button>
						 </form>
						</td>
						<td>
						<form action="updateProducts_action.php?col=product_colors" method="post">
							<b><?php echo $row['product_colors']; ?></b><br>
							<input type="text" size="10" name="product_colors">
							<input type="hidden" name="productsToUpdate" value="<?php echo $row['product_id'] ?>">
							<button type="submit" class="updateButton">Update</button>
						 </form>
						</td>
						<td>
						<form action="updateProducts_action.php?col=product_price" method="post">
							$<b><?php echo $row['product_price']; ?></b><br>
							<input type="text" size="10" name="product_price">
							<input type="hidden" name="productsToUpdate" value="<?php echo $row['product_id'] ?>">
							<button type="submit" class="updateButton">Update</button>
						 </form>
						 </td>
						 <td>
						 <form action="updateProducts_action.php?col=product_gender" method="post">
							<b><?php echo $row['product_gender']; ?></b><br>
						...
						<td>
						<form action="updateProducts_action.php?col=product_category" method="post">
						...
						<td>
						<form action="updateProducts_action.php?col=product_subCategory" method="post">
							<b><?php echo $row['product_subCategory']; ?></b><br>
					...
					<td style="align:center">
						<form action="removeProducts.php" method="post">
							<input type="hidden" name="productToDelete" value="<?php echo $row['product_id'] ?>">

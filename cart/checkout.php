...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../css/cart/checkout/checkout.css">
	<link rel="stylesheet" type="text/css" href="../css/cart/checkout/checkout1.css">
					...
					<div id="container_demo" >
						<div id="wrapper">
							<div id="admin" class="form">
								<form  method="post" action="transact.php" autocomplete="on" enctype="multipart/form-data"> 
									...
									<p> 
										<label for="billingAddress" class="billingAddress" data-icon="A">Billing Address:</label>
										<input id="billingAddress" name="billingAddress" type="text" placeholder="Billing Address" required />
									</p>
									<p> 
										<label for="billingCity" class="billingCity" data-icon="C">City:</label>
										<input id="billingCity" name="billingCity" type="text" placeholder="Billing City" required />
									</p>
									<p> 
										<label for="postalCode" class="postalCode" data-icon="P" >Postal Code:</label>
									...
									<p> 
										<label for="cardName" class="cardName" data-icon="C">Name on Card:</label>
										<input id="cardName" name="cardName" type="text" placeholder="Full Name" required />
									</p>
									<p> 
										<label for="cardNo" class="cardNo" data-icon="C">Card Number:</label>
										<input id="cardNo" name="cardNo" type="text" placeholder="Card Number" required pattern="[0-9]+" />
									</p>
									<p> 
										<label for="ccvCode" class="cvvCode" data-icon="C">CVV:</label>
										<input id="ccvCode" name="cvvCode" type="text" placeholder="CVV" required pattern="[0-9]+" />
									</p>
									<p> 
										<label for="expDate" class="expDate" data-icon="C">Expiry Date:</label>
										<input id="expDate" name="expDate" type="date" placeholder="Expiry Date" required />
									</p>									
									<p>
										<input type="checkbox" name="termsOfUse" required/>Do you accept to the <a href="../termsofuse.php">Terms & Conditions?</a>
									</p>
									<div id="checkout">
							...
							while($row = mysqli_fetch_assoc($result_set))
							{
								...
								$priceAftetGst = (($productPrice * $quantity) * 1.07);
						 } 
						} 
					?>
							</div>							
